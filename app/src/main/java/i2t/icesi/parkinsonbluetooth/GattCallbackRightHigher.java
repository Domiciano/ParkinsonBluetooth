...
public class GattCallbackRightHigher extends BluetoothGattCallback {
    ...
    interface ReadListener {
        void onDataReceivedRightHigher(GattCallbackRightHigher obj, byte[] data);
        void onConnectedRightHigher(GattCallbackRightHigher obj);
        void onDisconectedRightHigher(GattCallbackRightHigher gatt);
    }
    ...
    public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
        ...
        readListener.onDataReceivedRightHigher(this, msj);
    }
            ...
            Thread h = new Thread(){
                ...
                public void run() {
                    try {
                        ...
                        Thread.sleep(5000);
                        disconnecting = false;
                        readListener.onDisconectedRightHigher(GattCallbackRightHigher.this);
    ...
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        ...
        readListener.onConnectedRightHigher(this);
