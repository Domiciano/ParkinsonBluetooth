...
public class GattCallbackLeft extends BluetoothGattCallback {
    ...
    interface ReadListener {
        void onDataReceivedLeft(GattCallbackLeft obj, byte[] data);
        void onConnectedLeft(GattCallbackLeft obj);
        void onDisconectedLeft(GattCallbackLeft gatt);
    }
    ...
    public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
        ...
        readListener.onDataReceivedLeft(this, msj);
    }
            ...
            Thread h = new Thread(){
                ...
                public void run() {
                    try {
                        ...
                        Thread.sleep(5000);
                        disconnecting = false;
                        readListener.onDisconectedLeft(GattCallbackLeft.this);
    ...
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        ...
        readListener.onConnectedLeft(this);
