...
public class GattCallbackRight extends BluetoothGattCallback {
    ...
    interface ReadListener {
        void onDataReceivedRight(GattCallbackRight obj, byte[] data);
        void onConnectedRight(GattCallbackRight obj);
        void onDisconectedRight(GattCallbackRight gatt);
    }
    ...
    public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
        ...
        readListener.onDataReceivedRight(this, msj);
    }
            ...
            Thread h = new Thread(){
                ...
                public void run() {
                    try {
                        ...
                        Thread.sleep(5000);
                        disconnecting = false;
                        readListener.onDisconectedRight(GattCallbackRight.this);
    ...
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        ...
        readListener.onConnectedRight(this);
